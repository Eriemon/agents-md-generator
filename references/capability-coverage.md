...
| Evolution ownership | Automatic evolution belongs only to the `agents-md-generator` owner repository or its installed skill copy. Ordinary user work folders keep local handoff/experience governance but do not generate local `assets/templates/evolution/` output, and legacy mistaken output is archived then removed |
