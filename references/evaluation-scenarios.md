...
| Auto evolution | Every tenth completed handoff distills accepted core experience files into indexed `assets/templates/evolution/skill-template/` and `engineering-template/` guidance |
