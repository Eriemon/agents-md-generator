...
<p align="center">
  面向 Codex 的技能：把真实仓库整理成 AI 编程助手能够遵循的清晰、分层说明。
</p>
...
![规则生成：确认后的说明出现在正确的仓库作用域](assets/readme/rule-rendering-cn.png)
...
![交付预览：助手展示最终文件，便于确认和交接](assets/readme/evidence-guard-cn.png)
