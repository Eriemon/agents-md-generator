...
| Evolution support | `v1.0.0` removes evolution entirely. The skill keeps handoff/experience governance, but no longer generates or imports reusable evolution templates and clears legacy evolution artifacts during mutating governance flows or replacement installs |
...
| Confidence aggregation | `run_confidence_gate.py --review-base <sha>` combines quick validation, audit, source-governance verification, docs/AGENTS verification, evaluate, skill evals, work-folder governance, freshness, automated review, release gates, install skip, and optional external-skill evaluation evidence |
