...
- Handwritten source files and project tool scripts should stay within 1000 lines. If a file must exceed that limit, create and follow a decomposition plan before continuing.
- Non-GUI project tool scripts should live under `scripts/<family>/<function>/<name>.<ext>` and provide matching `shell`, `bat`, and `powershell` variants.
