...
| AGENTS.md compression | Root generated `AGENTS.md` stays within 15KB, scoped AGENTS files are not blocked by the old line rule, and over-limit root manual content blocks writes |
