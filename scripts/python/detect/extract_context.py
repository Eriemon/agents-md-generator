...
def main() -> None:
    ...
    参数：无，命令行参数从当前进程读取。
    返回：无，上下文候选以 JSON 写入标准输出。
    """

    # 解析器描述会作为该入口的公开帮助文本。
    parser = parse_args("Extract AGENTS.md context candidates from docs, ADRs, utilities, CI, and quality configs.")  # 当前检测入口参数解析器
