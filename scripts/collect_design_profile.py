...
def docs_contract(name: str) -> dict[str, Any]:
    ...
    return {
        ...
        "experience": {
            ...
            "evolution_templates": "assets/templates/evolution/{skill-template,engineering-template}/<type>/",
        },
        "development": {
...
def build_profile(project: Path, answers: dict[str, Any]) -> tuple[dict[str, Any] | None, list[str]]:
    ...
    profile = {
        ...
        "experience_contract": {
            ...
            "evolution_every_handoffs": 10,
            "evolution_templates": "assets/templates/evolution/{skill-template,engineering-template}/<type>/",
            "required_sections": ["evidence_read", "iterated_lessons", "next_application"],
        },
